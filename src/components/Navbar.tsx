        ...
        <nav className="hidden lg:flex items-center justify-center flex-1 px-4">
          <ul className="nav-links flex items-center gap-[20px] xl:gap-[28px] list-none mx-auto">
            <li>
              <Link
                href="/"
                className={`nav-item text-[13.5px] font-bold tracking-[0.3px] transition-colors py-2.5 px-3.5 rounded-[20px] ${activePage === "home"
            ...
            <li>
              <Link
                href="/about"
                className={`nav-item text-[13.5px] font-bold tracking-[0.3px] transition-colors py-2.5 px-3.5 rounded-[20px] ${activePage === "about"
                  ? "bg-[#D71920] text-white shadow-[0_3px_8px_rgba(215,25,32,0.15)] hover:bg-[#D71920]/90"
                  : "text-dark-light hover:text-[#D71920]"
                  }`}
              >
            ...
            <li>
              <Link
                href="/services"
                className={`nav-item text-[13.5px] font-bold tracking-[0.3px] transition-colors py-2.5 px-3.5 rounded-[20px] ${activePage === "services"
                  ? "bg-[#D71920] text-white shadow-[0_3px_8px_rgba(215,25,32,0.15)] hover:bg-[#D71920]/90"
                  : "text-dark-light hover:text-[#D71920]"
                  }`}
              >
            ...
            <li>
              <Link
                href="/track"
                className={`nav-item text-[13.5px] font-bold tracking-[0.3px] transition-colors py-2.5 px-3.5 rounded-[20px] ${activePage === "consignment"
                  ? "bg-[#D71920] text-white shadow-[0_3px_8px_rgba(215,25,32,0.15)] hover:bg-[#D71920]/90"
                  : "text-dark-light hover:text-[#D71920]"
                  }`}
              >
            ...
            <li>
              <Link
                href="/contact"
                className={`nav-item text-[13.5px] font-bold tracking-[0.3px] transition-colors py-2.5 px-3.5 rounded-[20px] ${activePage === "contact"
                  ? "bg-[#D71920] text-white shadow-[0_3px_8px_rgba(215,25,32,0.15)] hover:bg-[#D71920]/90"
                  : "text-dark-light hover:text-[#D71920]"
                  }`}
              >
        ...
        <div className="absolute top-[88px] left-0 w-full bg-white border-b border-black/[0.08] p-6 flex flex-col gap-4 shadow-lg lg:hidden z-40 animate-fade-in">
          <ul className="flex flex-col gap-3 list-none">
            <li>
              <Link
                href="/"
                className={`block w-full py-2.5 px-4 font-bold rounded-lg text-sm transition-colors ${activePage === "home"
            ...
            <li>
              <Link
                href="/about"
                className={`block w-full py-2.5 px-4 font-bold rounded-lg text-sm transition-colors ${activePage === "about"
                  ? "bg-[#D71920] text-white"
                  : "text-dark-light hover:text-[#D71920] hover:bg-gray-50"
                  }`}
              >
            ...
            <li>
              <Link
                href="/services"
                className={`block w-full py-2.5 px-4 font-bold rounded-lg text-sm transition-colors ${activePage === "services"
                  ? "bg-[#D71920] text-white"
                  : "text-dark-light hover:text-[#D71920] hover:bg-gray-50"
                  }`}
              >
            ...
            <li>
              <Link
                href="/track"
                className={`block w-full py-2.5 px-4 font-bold rounded-lg text-sm transition-colors ${activePage === "consignment"
                  ? "bg-[#D71920] text-white"
                  : "text-dark-light hover:text-[#D71920] hover:bg-gray-50"
                  }`}
              >
            ...
            <li>
              <Link
                href="/contact"
                className={`block w-full py-2.5 px-4 font-bold rounded-lg text-sm transition-colors ${activePage === "contact"
                  ? "bg-[#D71920] text-white"
                  : "text-dark-light hover:text-[#D71920] hover:bg-gray-50"
                  }`}
              >
